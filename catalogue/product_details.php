    ...
    <div class="cat-detail">
        ...
        <div class="cat-detail-info">
            ...
            <div class="cat-detail-actions mt-2">
                ...
                <a class="btn btn-outline cat-whatsapp-btn" target="_blank" rel="noopener noreferrer" href="https://wa.me/94703587028?text=<?php echo urlencode('Hi AutoParts Lanka, I would like to check compatibility for ' . $part['partName'] . ' (Part No: ' . $part['partNumber'] . ')'); ?>">
